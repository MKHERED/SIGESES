    ...
    <div class="bg-light col-sm-12 col-md-12">
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
               @if (isset($visit))
                    <div class="p-1">
					{{$visit->transceptor_marca}}  @if ($visit->transceptor_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
               @if (isset($visit))
                    <div class="p-1">
					{{$visit->transceptor_modelo}}  @if ($visit->transceptor_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->transceptor_serial}} @if ($visit->transceptor_serial == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->digitalizador_fecha}} @if ($visit->digitalizador_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->sensor_marca}} @if ($visit->sensor_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->sensor_modelo}} @if ($visit->sensor_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            @if (isset($visit))
                    <div class="p-1">
					{{$visit->sensor_serial}} @if ($visit->sensor_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            @if (isset($visit))
                    <div class="p-1">
				    {{$visit->sensor_sen}} @if ($visit->sensor_sen == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
               @if (isset($visit))
                    <div class="p-1">
					{{$visit->sensor_fecha}} @if ($visit->sensor_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
				    {{$visit->BUC_serial}} @if ($visit->BUC_serial == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            @if (isset($visit))
                    <div class="p-1">
					{{$visit->LNB_fecha}} @if ($visit->LNB_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            @if (isset($visit))
                    <div class="p-1">
					{{$visit->antena_gps_marca}} @if ($visit->antena_gps_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->antena_gps_modelo}} @if ($visit->antena_gps_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->antena_gps_serial}} @if ($visit->antena_gps_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->antena_gps_fecha}} @if ($visit->antena_gps_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_a_marca}} @if ($visit->panel_solar_a_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_a_modelo}}  @if ($visit->panel_solar_a_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_a_serial}}  @if ($visit->panel_solar_a_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_a_watts}}  @if ($visit->panel_solar_a_watts == "") &nbsp; @endif
                    </div>
				@else
            ...
            @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_a_fecha}}  @if ($visit->panel_solar_a_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_b_marca}}  @if ($visit->panel_solar_b_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_b_modelo}} @if ($visit->panel_solar_b_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_b_serial}} @if ($visit->panel_solar_b_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_b_watts}} @if ($visit->panel_solar_b_watts == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_b_fecha}} @if ($visit->panel_solar_b_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_c_marca}} @if ($visit->panel_solar_c_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_c_modelo}} @if ($visit->panel_solar_c_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_c_serial}} @if ($visit->panel_solar_c_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_c_watts}} @if ($visit->panel_solar_c_watts == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_c_fecha}} @if ($visit->panel_solar_c_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_d_marca}} @if ($visit->panel_solar_d_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_d_modelo}} @if ($visit->panel_solar_d_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_d_serial}} @if ($visit->panel_solar_d_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_d_watts}} @if ($visit->panel_solar_d_watts == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_d_fecha}} @if ($visit->panel_solar_d_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_e_marca}} @if ($visit->panel_solar_e_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_e_modelo}}  @if ($visit->panel_solar_e_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_e_serial}}  @if ($visit->panel_solar_e_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_e_watts}}  @if ($visit->panel_solar_e_watts == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->panel_solar_e_fecha}}  @if ($visit->panel_solar_e_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->banco_baterias_marca}}  @if ($visit->bancao_baterias_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->banco_baterias_modelo}} @if ($visit->bancao_baterias_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->banco_baterias_serial}} @if ($visit->bancao_baterias_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->banco_baterias_cantidad}} @if ($visit->bancao_baterias_cantidad == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->banco_baterias_watts}} .Qty @if ($visit->bancao_baterias_watts == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->banco_baterias_fecha}} @if ($visit->bancao_baterias_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row align-items-center p-1 border ">
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->regulador_voltaje_marca}} @if ($visit->regulador_voltaje_marca == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->regulador_voltaje_modelo}} @if ($visit->regulador_voltaje_modelo == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-2 border p-0">
                 @if (isset($visit))
                    <div class="p-1">
					{{$visit->regulador_voltaje_serial}} @if ($visit->regulador_voltaje_serial == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-4 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->regulador_voltaje_watts}} @if ($visit->regulador_voltaje_watts == "") &nbsp; @endif
                    </div>
				@else
            ...
            <div class="col-12 col-md-1 border p-0">
                @if (isset($visit))
                    <div class="p-1">
					{{$visit->regulador_voltaje_fecha}} @if ($visit->regulador_voltaje_fecha == "") &nbsp; @endif
                    </div>
				@else
        ...
        <div class="text-center row p-1 ">
            <div class="col-12 col-md-12 col-lg-6 border p-0 ">
                ...
                <div class="">
                    @if (isset($visit))
                        <div class="border text-break p-1 overflow-auto" style="height:300px;">
                            {{$visit->trabajo}}
                        </div>
            ...
            <div class="col-12 col-md-12 col-lg-6 border p-0 " style="height:325px">
                ...
                <!-- !(isset($link_docs)) -->
                @if (!isset($visit)) 
                    <input class="form-control form-control-sm rounded-0" type="file" id="imagen0" name="imagen_n" onchange="muestraImg('muestrasImg', 'imagen0', '0');">
                @endif
                </div>
                <!--style>
                    #muestrasImg {
                ...
                @if (isset($link_docs))
                    <img class="mt-1 mb-1 rounded" src="{{asset('storage').'/'.$link_docs->direccion}}" height="290px">
                @else
